        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="kt_modal_add_user_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Formulario de Sub categoria</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6 bg-light-primary">
            ...
            <div class="card-title">
                <h2>Listado de Sub Categoria</h2>
            </div>
            <!--begin::Card title-->
            <!--begin::Card toolbar-->
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <i class="ki-duotone ki-plus fs-2"></i>Nueva Sub Categoria</button>
                    <!--end::Add user-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
    ...
    <script type="text/javascript">
       ...
       function guardar(){
        ...
        function ajaxListado(){
            $.ajax({
                url: "{{ url('subcategoria/ajaxListado') }}",
                type: 'POST',
                dataType: 'json',
                success: function(data) {
                    if(data.estado === 'success')
        ...
        function elimina(categoria, nombre){
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if(data.estado === 'success'){
                                ...
                                Swal.fire(
                                    'Eliminado!',
                                    'Se elimino con exito la categoria.',
                                    'success'
                                )
                            }
                        }
        ...
        function edita(subcategoria, nombre, descripcion, categoria) {
            $('#subcategoria_id').val(subcategoria)
            $('#nombre').val(nombre)
